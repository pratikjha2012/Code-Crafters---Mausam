...
export default function Footer() {
  ...
  return (
    <footer className="mt-12 border-t border-slate-800 bg-slate-950/95 backdrop-blur-md text-slate-400 text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-2xl bg-slate-900 border border-slate-800">
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs font-mono">
            <span className="bg-slate-950 px-2.5 py-1 rounded-lg border border-slate-800">NDMA Disaster: <strong className="text-white">1070</strong></span>
            <span className="bg-slate-950 px-2.5 py-1 rounded-lg border border-slate-800">National Emergency: <strong className="text-white">112</strong></span>
            <span className="bg-slate-950 px-2.5 py-1 rounded-lg border border-slate-800">Kisan Call Centre: <strong className="text-white">1800-180-1551</strong></span>
          </div>
        </div>
